...
modDatetime: 2026-06-19T04:47:06+08:00
...
$D_{AB}$ 度量了单倍型频率 $P_{(AB)}$ 偏离期望频率的程度。若 $D_{AB}$ 为 0，则 单倍型 AB 出现的频率等于期望频率，也就意味着两位点间达到了连锁平衡（LE）；若 $D_{AB}$ 不为 0，则存在 LD，D 越大代表连锁不平衡程度越大。
