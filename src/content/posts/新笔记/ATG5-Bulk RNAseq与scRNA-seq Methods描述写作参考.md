...
```
References:
1. Wang et al., 2025. Methods 2.3 describes GO and KEGG functional annotation of DEGs using clusterProfiler v4.4.4. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12639471/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12639471/)
...
```
References:
1. Wang et al., 2025. Methods 2.3 explicitly describes GO and KEGG pathway analyses using clusterProfiler. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12639471/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12639471/)
...
```
References:
1. Wang et al., 2025. Methods 2.4 describes KEGG-based GSEA using clusterProfiler. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12639471/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12639471/)
...
```
References:
1. Coburn et al., 2025. Methods 2.10 describes Seurat, QC, PCA, FindNeighbors, FindClusters, and RunUMAP. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12635866/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12635866/)
2. Mathys et al., 2019. Classic AD human brain snRNA-seq paper; includes single-nucleus clustering and cell-type analysis. [https://pmc.ncbi.nlm.nih.gov/articles/PMC6865822/](https://pmc.ncbi.nlm.nih.gov/articles/PMC6865822/)
3. Nagata et al., 2024. AD model snRNA-seq; includes microglial state clustering and analysis. [https://pmc.ncbi.nlm.nih.gov/articles/PMC11628182/](https://pmc.ncbi.nlm.nih.gov/articles/PMC11628182/)
...
```
References:
1. Coburn et al., 2025. Methods 2.10 describes FindAllMarkers, Wilcoxon rank-sum test, FDR, LFC, minimum expression percentage, and manual curation. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12635866/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12635866/)
2. Mathys et al., 2019. Classic AD snRNA-seq paper for cell-type marker and annotation reference. [https://pmc.ncbi.nlm.nih.gov/articles/PMC6865822/](https://pmc.ncbi.nlm.nih.gov/articles/PMC6865822/)
3. Nagata et al., 2024. AD model paper using markers to distinguish microglial states. [https://pmc.ncbi.nlm.nih.gov/articles/PMC11628182/](https://pmc.ncbi.nlm.nih.gov/articles/PMC11628182/)
...
References:
1. Ayata et al., 2025. Extended Data Fig. 12 describes UMAP, dot plot, and feature plots for marker visualization. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12675299/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12675299/)
2. Coburn et al., 2025. Provides scRNA-seq clusters and marker expression visualization reference. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12635866/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12635866/)
3. Nagata et al., 2024. Provides microglial subcluster marker and cell-state visualization reference. [https://pmc.ncbi.nlm.nih.gov/articles/PMC11628182/](https://pmc.ncbi.nlm.nih.gov/articles/PMC11628182/)
...
```
References:
1. Ayata et al., 2025. Extended Data Fig. 12 uses bar graphs to show percentage changes in microglial subpopulations. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12675299/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12675299/)
2. Coburn et al., 2025. Methods 2.11 describes differential proportion analysis. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12635866/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12635866/)
3. Nagata et al., 2024. Figure 3/Results compare microglial cluster frequencies. [https://pmc.ncbi.nlm.nih.gov/articles/PMC11628182/](https://pmc.ncbi.nlm.nih.gov/articles/PMC11628182/)
...
```
References:
1. Coburn et al., 2025. Methods 2.13 describes Gene ontology network and transcription factor analysis. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12635866/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12635866/)
2. Nagata et al., 2024. AD model snRNA-seq paper using differential genes for GO enrichment analysis. [https://pmc.ncbi.nlm.nih.gov/articles/PMC11628182/](https://pmc.ncbi.nlm.nih.gov/articles/PMC11628182/)
3. Ayata et al., 2025. Uses enrichment/GSEA analyses to interpret microglial functional gene programs. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12675299/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12675299/)
...
References:
1. Wang et al., 2025. AD RNA-seq Methods 2.3 gives a standard clusterProfiler KEGG description, transferable to cell-type-specific DEGs. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12639471/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12639471/)
2. Siregar et al., 2026. Methods 2.5 describes GO/KEGG/GSEA integrative pathway analysis. [https://pmc.ncbi.nlm.nih.gov/articles/PMC13116960/](https://pmc.ncbi.nlm.nih.gov/articles/PMC13116960/)
3. Baker et al., 2026. Methods describes KEGG pathway ORA. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12931797/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12931797/)
...
References:
1. Ayata et al., 2025. AD/microglia study using GSEA analyses to interpret functional gene programs. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12675299/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12675299/)
2. Karthivashan et al., 2026. 5xFAD bulk RNA-seq Methods 2.6 provides GSEA/MSigDB phrasing applicable to single-cell ranked genes. [https://pmc.ncbi.nlm.nih.gov/articles/PMC13240024/](https://pmc.ncbi.nlm.nih.gov/articles/PMC13240024/)
3. Wang et al., 2025. Methods 2.4 describes KEGG-based GSEA with clusterProfiler. [https://pmc.ncbi.nlm.nih.gov/articles/PMC12639471/](https://pmc.ncbi.nlm.nih.gov/articles/PMC12639471/)
